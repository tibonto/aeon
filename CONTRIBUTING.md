...
- **Does the term already exist?** Before submitting suggestions for new ontology terms, check whether the term exist, either as a primary term or a synonym term. You can search using the [TIB Terminology Service](https://service.tib.eu/ts4tib/ontologies/aeon).
...
On behalf of the Academic Event Ontology editorial team, Thanks!
